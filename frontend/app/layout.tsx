  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        {/* Favicon / icon links are auto-generated by Next.js from
            frontend/app/icon.png, apple-icon.png, and favicon.ico.
            The manifest is referenced explicitly so PWA install works. */}
