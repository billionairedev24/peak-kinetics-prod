...
public class EmailService implements IEmailNotificationService {
    ...
    public void sendPasswordResetEmail(String toEmail, String resetToken, HttpServletRequest httpServletRequest)
    ...
    public void sendReviewRequestEmail(String toEmail, String clientName, HttpServletRequest httpServletRequest)
            throws ResendException {
    ...
    public void sendReferralRequestEmail(String toEmail, String clientName, HttpServletRequest httpServletRequest)
            throws ResendException {
        Span span = tracer.spanBuilder("email.sendReferralRequest").startSpan();
        try {
            String html = buildReferralRequestTemplate(clientName, httpServletRequest);
            sendEmail(toEmail, "We Appreciate Your Referral - Peak Kinetics", html);
            span.setAttribute("email.recipient", toEmail);
        } finally {
            span.end();
        }
    ...
    private String buildReferralRequestTemplate(String clientName, HttpServletRequest httpServletRequest) {
        String referralUrl = getBaseUrl(httpServletRequest) + "/referral";
        return String.format(
                """
                        <!DOCTYPE html>
                        <html>
                        ...
                        <body>
                            <div class="container">
                                <div class="header">
                                    <h1>Help Others Peak!</h1>
                                </div>
                                <div class="content">
                                    <h2>Hello %s,</h2>
                                    <p>We hope you're feeling great and making excellent progress in your journey with Peak Kinetics!</p>
                                    <p>If you have friends or family who could benefit from our specialized physical therapy services, we'd be honored if you'd refer them to us.</p>
                                    <p>Referring someone is the highest compliment we can receive!</p>
                                    <a href="%s" class="button">Refer a Friend</a>
                                    <p>Thank you for your trust and support,<br>The Peak Kinetics Team</p>
                                </div>
                                <div class="footer">
                                    <p>&copy; 2024 Peak Kinetics. All rights reserved.</p>
                                </div>
